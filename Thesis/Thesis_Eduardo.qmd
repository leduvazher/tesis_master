...
# Convertir a plotly con opciones de leyenda
ggplotly(ph, width = 950, height = 450) %>%
  layout(
    legend = list(
      bgcolor = "transparent",  # Alternativa a rgba(0,0,0,0)
      font = list(color = "black") # Asegurar texto negro
    ),
    plot_bgcolor = "transparent", 
    paper_bgcolor = "transparent"
  ) %>%
  config(displayModeBar = FALSE)  # Oculta barra de herramientas para evitar conflictos de renderizado
